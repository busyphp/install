...
('文件上传', 'manual_component/upload', '#developer_manual_component', '', '', 'fa fa-cloud-upload', '', 0, 0, 1, 4),
('数据表格', 'manual_component/table', '#developer_manual_component', '', '', 'bicon bicon-table', '', 0, 0, 1, 5),
('树形组件', 'manual_component/tree', '#developer_manual_component', '', '', 'bicon bicon-tree', '', 0, 0, 1, 6),
('联级选择器', 'manual_component/linkage_picker', '#developer_manual_component', '', '', 'bicon bicon-tree', '', 0, 0, 1, 7),
('穿梭框', 'manual_component/shuttle', '#developer_manual_component', '', '', 'fa fa-exchange', '', 0, 0, 1, 8),
('全选/反选', 'manual_component/check_all', '#developer_manual_component', '', '', 'fa fa-check-square-o', '', 0, 0, 1, 9),
('搜索栏', 'manual_component/search_bar', '#developer_manual_component', '', '', 'fa fa-search', '', 0, 0, 1, 10),
('自动表单', 'manual_component/form', '#developer_manual_component', '', '', 'fa fa-wpforms', '', 0, 0, 1, 11),
('表单验证', 'manual_component/form_verify', '#developer_manual_component', '', '', 'fa fa-check', '', 0, 0, 1, 12),
('自动请求', 'manual_component/request', '#developer_manual_component', '', '', 'fa fa-random', '', 0, 0, 1, 13),
('日期/时间', 'manual_component/date', '#developer_manual_component', '', '', 'fa fa-calendar', '', 0, 0, 1, 14),
('下拉选择器', 'manual_component/select_picker', '#developer_manual_component', '', '', 'bicon bicon-down-menu', '', 0, 0, 1, 15),
('Checkbox/Radio', 'manual_component/checkbox_radio', '#developer_manual_component', '', '', 'bicon bicon-checkbox-checked', '', 0, 0, 1, 16),
('输入提示', 'manual_component/autocomplete', '#developer_manual_component', '', '', 'fa fa-pencil', '', 0, 0, 1, 17),
('下拉菜单', 'manual_component/dropdown', '#developer_manual_component', '', '', 'fa fa-chevron-circle-down', '', 0, 0, 1, 18),
('选项卡', 'manual_component/tab', '#developer_manual_component', '', '', 'fa fa-flag-o', '', 0, 0, 1, 19),
('提示工具', 'manual_component/tooltip', '#developer_manual_component', '', '', 'fa fa-commenting-o', '', 0, 0, 1, 20),
('弹出框', 'manual_component/popover', '#developer_manual_component', '', '', 'fa fa-comment-o', '', 0, 0, 1, 21),
('折叠面板', 'manual_component/collapse', '#developer_manual_component', '', '', 'fa fa-server', '', 0, 0, 1, 22),
('富文本编辑器', 'manual_component/editor', '#developer_manual_component', '', '', 'fa fa-edit', '', 0, 0, 1, 24),
('颜色选择器', 'manual_component/color_picker', '#developer_manual_component', '', '', 'fa fa-eyedropper', '', 0, 0, 1, 24),
('图片预览', 'manual_component/image_viewer', '#developer_manual_component', '', '', 'bicon bicon-image-viewer', '', 0, 0, 1, 25),
('视频预览', 'manual_component/video_viewer', '#developer_manual_component', '', '', 'bicon bicon-video', '', 0, 0, 1, 26),
('图标选择器', 'manual_component/icon_picker', '#developer_manual_component', '', '', 'bicon bicon-dcs', '', 0, 0, 1, 27),
('滑块', 'manual_component/range_slider', '#developer_manual_component', '', '', 'fa fa-sliders', '', 0, 0, 0, 28),
('评分', 'manual_component/rate', '#developer_manual_component', '', '', 'fa fa-star-o', '', 0, 0, 0, 29),
('日历', 'manual_component/calendar', '#developer_manual_component', '', '', 'bicon bicon-calendar-block', '', 0, 0, 0, 30),
('代码高亮', 'manual_component/high_code', '#developer_manual_component', '', '', 'fa fa-file-code-o', '', 0, 0, 1, 31),
('目录', 'manual_component/catalog', '#developer_manual_component', '', '', 'fa fa-list-ol', '', 0, 0, 1, 32),
('复制/剪切', 'manual_component/copy', '#developer_manual_component', '', '', 'fa fa-copy', '', 0, 0, 1, 33),
('随机字符', 'manual_component/random', '#developer_manual_component', '', '', 'fa fa-refresh', '', 0, 0, 1, 34),
