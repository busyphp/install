...
('图标选择器', 'manual_component/icon_picker', '#developer_manual_component', '', '', 'bicon bicon-dcs', '', 0, 0, 1, 18),
...
('联级选择器', 'manual_component/linkage_picker', '#developer_manual_component', '', '', 'bicon bicon-tree', '', 0, 0, 1, 5),
